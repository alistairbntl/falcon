...
def test_dof_handler_3(basic_mesh_bdm1):
    ...
    assert dof_handler.get_local_2_global(0,3) == 7
    assert dof_handler.get_local_2_global(0,4) == 5
    assert dof_handler.get_local_2_global(0,5) == 6
    ...
    assert dof_handler.get_local_2_global(1,4) == 8
    assert dof_handler.get_local_2_global(1,5) == 7

def test_dof_handler_4(basic_mesh_p1):
    dof_handler = basic_mesh_p1
    assert dof_handler.get_local_2_global(0,0) == 0
    assert dof_handler.get_local_2_global(0,1) == 1
    assert dof_handler.get_local_2_global(0,2) == 2
...
def test_dof_handler_5(basic_mesh_bdm2):
    ...
    E0_expected = [2,0,1,7,5,6,12,10,11,15,17,19]
    E1_expected = [4,3,2,9,8,7,14,13,12,16,18,20]
...
def test_mixed_dof_handler_2(basis_mesh_bdm1_p0):
    basis, mesh, dof_handler = basis_mesh_bdm1_p0
    assert np.array_equal(dof_handler._l2g_map[0],[2, 0, 1, 7, 5, 6, 10])
    assert np.array_equal(dof_handler._l2g_map[1],[4, 3, 2, 9, 8, 7, 11])
...
def test_mixed_dof_handler_4(basis_mesh_bdm2_p1):
    ...
    assert np.array_equal(dof_handler._l2g_map[0],
                          [2,0,1,7,5,6,12,10,11,15,17,19,21,22,23])
    assert np.array_equal(dof_handler._l2g_map[1],
                          [4,3,2,9,8,7,14,13,12,16,18,20,22,23,24])
